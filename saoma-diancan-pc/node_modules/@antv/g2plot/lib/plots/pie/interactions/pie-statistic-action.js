...
var StatisticAction = /** @class */ (function (_super) {
    ...
    StatisticAction.prototype.change = function (arg) {
        ...
        var data = util_1.get(event, ['data', 'data']);
        ...
        if (data) {
            var annotations = util_1.get(arg, 'annotations', []);
            var statistic = util_1.get(arg, 'statistic', {});
            // 先清空标注，再重新渲染
            ...
            statistic_1.renderStatistic(view, { statistic: statistic, plotType: 'pie' }, data);
            view.render(true);
        }
    };
