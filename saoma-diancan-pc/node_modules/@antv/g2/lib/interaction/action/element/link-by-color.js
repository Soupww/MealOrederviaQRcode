...
var LinkByColor = /** @class */ (function (_super) {
    ...
    LinkByColor.prototype.addLinkShape = function (group, element, nextElement, activeStyle) {
        ...
        group.addShape({
            type: 'path',
            attrs: tslib_1.__assign(tslib_1.__assign({}, util_2.deepMix({}, style, util_2.isFunction(activeStyle) ? activeStyle(style, element) : activeStyle)), { path: this.getLinkPath(element, nextElement) }),
        });
    };
    // 使用图形连接
