...
var Scrollbar = /** @class */ (function (_super) {
    ...
    Scrollbar.prototype.getThemeOptions = function () {
        ...
        return util_1.get(theme, ['components', 'scrollbar', 'common'], {});
    };
    /**
     * 获取 scrollbar 组件的主题样式
     */
    Scrollbar.prototype.getScrollbarTheme = function (style) {
        var theme = util_1.get(this.view.getTheme(), ['components', 'scrollbar']);
        var _a = style || {}, thumbHighlightColor = _a.thumbHighlightColor, restStyles = tslib_1.__rest(_a, ["thumbHighlightColor"]);
        return {
            default: util_1.deepMix({}, util_1.get(theme, ['default', 'style'], {}), restStyles),
            hover: util_1.deepMix({}, util_1.get(theme, ['hover', 'style'], {}), { thumbColor: thumbHighlightColor }),
        };
    };
