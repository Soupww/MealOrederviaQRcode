...
var View = /** @class */ (function (_super) {
    ...
    View.prototype.legend = function (field, legendOption) {
        if (util_1.isBoolean(field)) {
            ...
            if (util_1.isPlainObject(legendOption) && (legendOption === null || legendOption === void 0 ? void 0 : legendOption.selected)) {
                util_1.set(this.options, ['filters', field], function (name) {
                    var _a;
